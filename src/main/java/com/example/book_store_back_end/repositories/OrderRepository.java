...
public interface OrderRepository extends JpaRepository<Order,Long> {
    ...
    //普通用户统计自己购买书籍的情况
    @Query("SELECT new com.example.book_store_back_end.dto.StatBookDto(oi.book.bid, oi.book.imagePath, oi.book.name, SUM(oi.amount), SUM(oi.amount * oi.book.price))"
            + " FROM Order o"
    ...
    //统计用户消费情况
    @Query("SELECT new com.example.book_store_back_end.dto.ConsumptionDto(o.uid, u.name, SUM(o.price))"
            + " FROM Order o"
